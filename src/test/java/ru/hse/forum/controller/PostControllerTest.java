...
class PostControllerTest {
    ...
    void shouldCreatePost() throws Exception {
        PostResponse postRequest1 = new PostResponse(1L, "Post Name", "Description", "User 1",
                "Forum Section 1", 0, 0, false, false);
        PostResponse postRequest2 = new PostResponse(2L, "Post Name 2", "Description2", "User 2",
